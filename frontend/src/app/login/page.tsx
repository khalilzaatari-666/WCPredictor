...
export default function LoginPage() {
  ...
  const handleWalletLogin = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const message = `Sign this message to login to WC2026 Predictor: ${Date.now()}`;
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        >
              ...
              >
                ...
                <div className="flex items-center justify-between text-sm">
                  ...
                  <Link
                    ...
                    className="text-wc-primary hover:underline"
                  >
                    Forgot password?
                  </Link>
                </div>
              ...
              >
                <div className="p-4 rounded-lg bg-wc-primary/10 border border-wc-primary/20">
                  <p className="text-sm text-center mb-2">
                    Connect your crypto wallet to sign in
                  </p>
          ...
          <p className="text-center text-sm text-muted-foreground mt-6">
            ...
            <Link href="/register" className="text-wc-primary hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </motion.div>
